export const comandos = `<b>Comandos</b>
...
`;
export const vagaDemo = `<b>Demo de vaga</b>
...
export const postCabecalho = `<b>Cabeçalho do post</b>
...
export const vagaModeloIncrementado = `<b>Modelo incrementado de vagas</b>
...
export const voluntariadoModelo = `<b>Template para voluntário</b>
💻 #dados #ia #tecnologia
🌎 #remoto
♀️ #ParaMulheres
💞 #Voluntariado
...
export const cursoTemplate = `<b>Template para curso</b>
...
export const eventoTemplate = `<b>Template para evento</b>
...
export const artigoTemplate = `<b>Template para artigo</b>
...
export const dicaTemplate = `<b>Template para dica</b>
...
<code>♀️ #ParaMulheresNegras</code>
♀️ #ParaMulheresNegras

<code>✊🏿 #PessoasNegras</code>
✊🏿 #PessoasNegras
...
<code>👵🏽 #MelhorIdade</code>
👵🏽 #MelhorIdade

<code>🏳‍⚧ #PessoasTrans</code>
🏳‍⚧ #PessoasTrans
`;

export const comoFormatar = `<b>Como formatar texto</b>
